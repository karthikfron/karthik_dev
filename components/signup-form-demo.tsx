    ...
    >
      ...
      <section className="flex flex-col items-center md:w-1/2 text-center space-y-6 md:space-y-8">
        ...
        <button
          ...
          type="button"
        >
          <Link href="https://twitter.com/dotenvk?" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
        ...
        <button
          ...
          type="button"
        >
          <Link href="https://github.com/karthikfron" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
        ...
        <button
          ...
          type="button"
        >
          <Link href="https://linkedin.com/in/karthikmokara" target="_blank" rel="noopener noreferrer" className="flex space-x-2">
